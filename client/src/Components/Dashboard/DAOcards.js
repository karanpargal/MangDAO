...
const DAOcards = (props) => {
    return (
        ...
        <div className="bg-white rounded-xl shadow-2xl w-[400px] ">
          ...
          <div className="flex bg-slate-100 pl-8 py-4 mt-4">
          <ArrowSmRightIcon className="  w-5 ml-2  text-indigo-600" />
            <button className=" item-center text-indigo-600 border-none">
